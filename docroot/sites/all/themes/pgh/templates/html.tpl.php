...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  <!--[if lt IE 9]>
  <p class="browser-message" style="display:none;">
  ...
  <div id="browser-message-modal">
    ...
    <p>
    <?php print t('If you are using Internet Explorer 7 or 8, you will need to upgrade your browser to utilize this website. Check your browser here: whatbrowser.org and <a href="http://browsehappy.com/">download an alternative browser</a> if necessary.'); ?>
    </p>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $('#browser-message-modal .confirm').click(function() {
        $(this).hide();
